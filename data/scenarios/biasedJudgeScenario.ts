const biasedJudgeScenario = {
  ...
  link: "/exploration/biasedJudgeScenario",
  image:
  ...
  exploration: [
    {
      text: "The AI sentencing tool recommends a longer sentence for a minority defendant. What do you decide?",
      choices: [
        { text: "Override the AI and advocate for fairness.", outcome: "OverrideAI" },
        { text: "Improve the AI system to address biases.", outcome: "ImproveAI" },
        { text: "Accept the AI recommendation for efficiency.", outcome: "AcceptAI" },
        { text: "Pause the AI system for a thorough review.", outcome: "PauseAI" },
      ],
    },
    {
      text: "Overriding the AI raises questions about the tool's reliability. What is your next step?",
      choices: [
        { text: "Propose scrapping AI tools in sentencing.", outcome: "ScrapAI" },
        { text: "Push for improvements to reduce biases.", outcome: "ImproveAI" },
      ],
    },
    {
      text: "Public backlash over bias grows. How do you respond?",
      choices: [
        { text: "Reintroduce the AI with transparency and oversight.", outcome: "AuditAI" },
        { text: "Defend the AI system, emphasizing its efficiency.", outcome: "DefendAI" },
      ],
    },
  ],
