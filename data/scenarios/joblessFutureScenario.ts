export const joblessFutureScenario = {
  ...
  link: "/exploration/joblessFutureScenario",
  image:
  ...
  exploration: [
    {
      text: "Unemployment is rising as AI automates jobs across industries. How do you respond?",
      choices: [
        {
          text: "Implement Universal Basic Income (UBI) to support displaced workers.",
          outcome: "ImplementUBI",
        },
        {
          text: "Fund worker retraining programs using an AI tax.",
          outcome: "RetrainingPrograms",
        },
        {
          text: "Let the market self-regulate and foster innovation.",
          outcome: "SelfRegulate",
        },
        {
          text: "Propose job-sharing initiatives to reduce unemployment.",
          outcome: "JobSharing",
        },
      ],
    },
    {
      text: "UBI reduces poverty, but critics argue it disincentivizes work. How will you address the concerns?",
      choices: [
        {
          text: "Raise business taxes to fund UBI sustainably.",
          outcome: "TaxBusinesses",
        },
        {
          text: "Scale back UBI to encourage workforce participation.",
          outcome: "ScaleBackUBI",
        },
      ],
    },
    {
      text: "Worker retraining programs are underway but progress is slow. What next?",
      choices: [
        {
          text: "Expand retraining efforts with government subsidies.",
          outcome: "ExpandRetraining",
        },
        {
          text: "Focus on retraining workers for AI-driven industries.",
          outcome: "TargetRetraining",
        },
      ],
    },
    {
      text: "Public protests increase as the market fails to create enough new jobs. How do you proceed?",
      choices: [
        {
          text: "Reassess and introduce intervention policies.",
          outcome: "ReassessIntervention",
        },
        {
          text: "Prioritize innovation and wait for market forces to adjust.",
          outcome: "PrioritizeInnovation",
        },
      ],
    },
  ],
